...
// Apenas os números pares e divisiveis por 5
const list = [20,3,234,25,30,50,50,60,70,275,800, 12, 1000, 541,6, 17,275] 

const newList = list.filter(list => list %2 === 0 && list %5 === 0)

console.log(newList);

// Depois de 1975 e mais de 2000
...
const newCompanies = companies.filter(compan => compan.ValorMercado >= 100 && compan.Ano >= 1970)
